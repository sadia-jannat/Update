...
class ownerformfill(models.Model):
   ...
   #but page a drop down ta astese na..karon form.py a widgets dity pari nai tai..widget dily image ase na tai.interview sesh holy boshabo
    housecategory=models.CharField(choices=HOUSE_CATEGORY, max_length=200)  
    #housecategory=models.CharField(max_length=200)
